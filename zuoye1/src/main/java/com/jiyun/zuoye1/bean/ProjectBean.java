...
public class ProjectBean {
    ...
    public static class DataBean {
        ...
        public static class DatasBean {
             ...
             * collect : false
             * courseId : 13
             * desc : 毕设项目，自己搭建的前后台，Android使用 Kotlin + RxJava + Retrofit + MVP 实现。比较好的封装了代码以及多状态界面的切换。后台代码也可以看到，通过 IDEA 使用 SSM 搭建。
             * envelopePic : https://www.wanandroid.com/resources/image/pc/default_project_img.jpg
             * fresh : false
             * id : 8605
             * link : http://www.wanandroid.com/blog/show/2609
             * niceDate : 2019-06-12
             * origin :
             * prefix :
             * projectLink : https://github.com/jiwenjie/Graduation_App
             * publishTime : 1560352439000
             * superChapterId : 294
             * superChapterName : 开源项目主Tab
             * tags : [{"name":"项目","url":"/project/list/1?cid=294"}]
             * title : Meterail Design风格毕设项目
             * type : 0
             * userId : -1
             * visible : 0
             * zan : 0
